...
def vecina_minima_distancia(x):
    cell_vecinas_eri3g = open("C:\\Desarrollo_Pablo\\Estad\\vecinas_hua3g.json", "r")
...
celdas_largo_alcance_file=pd.read_csv("C:\\Desarrollo_Pablo\\Estad\\LARGO_ALCANCE_HUA.csv",sep=',',decimal='.')
celdas_largo_alcance_list=celdas_largo_alcance_file['celda'].tolist()
alcance_list=celdas_largo_alcance_file['3G_HUA_ALCANCE_CELDA_KM'].tolist()
minutos_list=celdas_largo_alcance_file['3G_Minutes_Voice'].tolist()

dict_alcance={}

csv_file=open('C:\\Desarrollo_Pablo\\Estad\\hua_largo_alcance_vecina.csv','wb')
